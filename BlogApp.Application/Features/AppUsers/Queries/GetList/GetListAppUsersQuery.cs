...
namespace BlogApp.Application.Features.AppUsers.Queries.GetList
{
    public class GetListAppUsersQuery : IRequest<GetListResponse<GetListAppUserResponse>>
    {
        ...
        public class GetAllUserQueryHandler(UserManager<AppUser> userManager, IMapper mapper) : IRequestHandler<GetListAppUsersQuery, GetListResponse<GetListAppUserResponse>>
        {
