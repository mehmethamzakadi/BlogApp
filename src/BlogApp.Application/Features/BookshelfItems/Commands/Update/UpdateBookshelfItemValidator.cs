...
/// <summary>
/// Validator for UpdateBookshelfItemCommand with security rules.
/// Uses HtmlSanitizer-based whitelist approach for XSS prevention.
/// </summary>
public sealed class UpdateBookshelfItemValidator : AbstractValidator<UpdateBookshelfItemCommand>
{
    public UpdateBookshelfItemValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage("Geçerli bir kayıt kimliği belirtilmelidir.");
