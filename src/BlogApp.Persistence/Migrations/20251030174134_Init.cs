...
namespace BlogApp.Persistence.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "UserRoles",
                columns: new[] { "Id", "AssignedDate", "CreatedById", "CreatedDate", "DeletedDate", "IsDeleted", "RoleId", "UpdatedById", "UpdatedDate", "UserId" },
                values: new object[,]
                {
                    { new Guid("30000000-0000-0000-0000-000000000001"), new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), null, new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), null, false, new Guid("20000000-0000-0000-0000-000000000001"), null, new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("30000000-0000-0000-0000-000000000002"), new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), null, new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), null, false, new Guid("20000000-0000-0000-0000-000000000004"), null, new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("30000000-0000-0000-0000-000000000003"), new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), null, new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), null, false, new Guid("20000000-0000-0000-0000-000000000002"), null, new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("30000000-0000-0000-0000-000000000004"), new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), null, new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), null, false, new Guid("20000000-0000-0000-0000-000000000003"), null, new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), new Guid("00000000-0000-0000-0000-000000000003") },
                    { new Guid("30000000-0000-0000-0000-000000000005"), new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), null, new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), null, false, new Guid("20000000-0000-0000-0000-000000000002"), null, new DateTime(2025, 10, 23, 7, 0, 0, 0, DateTimeKind.Utc), new Guid("00000000-0000-0000-0000-000000000003") },
